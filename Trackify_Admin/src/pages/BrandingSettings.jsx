  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-100">Company Branding</h1>
        ...
        <button
          ...
          style={{
            backgroundColor: isDirty ? formData.themeColor : '#374151',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#1A1D24] p-6 rounded-xl border border-gray-800">
            <h2 className="text-lg font-medium text-gray-100 mb-4">Basic Information</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  maxLength={60}
                  className="w-full bg-[#2A2D35] border border-gray-700 rounded-lg px-4 py-2 text-gray-100 focus:outline-none focus:border-brand-primary"
                />
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1 md:col-span-2">
                ...
                <textarea
                  ...
                  maxLength={200}
                  rows={2}
                  className="w-full bg-[#2A2D35] border border-gray-700 rounded-lg px-4 py-2 text-gray-100 focus:outline-none focus:border-brand-primary resize-none"
                />
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#2A2D35] border border-gray-700 rounded-lg px-4 py-2 text-gray-100 focus:outline-none focus:border-brand-primary uppercase"
                />
              </div>
            </div>
          </div>
          ...
          {/* Logo Section */}
          <div className="bg-[#1A1D24] p-6 rounded-xl border border-gray-800">
            <h2 className="text-lg font-medium text-gray-100 mb-4">Logo</h2>
              ...
              {branding.logoUrl ? (
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="flex gap-2">
                    <label className="text-sm text-brand-primary hover:underline cursor-pointer">
                      Change
                      <input type="file" hidden accept="image/png, image/jpeg, image/webp" onChange={uploadLogo} />
                    </label>
                    <span className="text-gray-600">|</span>
                    <button onClick={handleRemoveLogo} className="text-sm text-red-500 hover:underline">
                      Remove
                    </button>
                  </div>
                </div>
              ) : (
                <label className="w-full border-2 border-dashed border-gray-700 hover:border-gray-500 rounded-xl p-8 flex flex-col items-center justify-center cursor-pointer transition-colors bg-[#2A2D35]">
                  <input type="file" hidden accept="image/png, image/jpeg, image/webp" onChange={uploadLogo} />
                  {uploading ? (
                    ...
                    <>
                      ...
                      <span className="text-xs text-gray-500">Recommended: 512×512px square</span>
                    </>
                  )}
                </label>
              )}
          ...
          {/* Theme Color Section */}
          <div className="bg-[#1A1D24] p-6 rounded-xl border border-gray-800">
            <h2 className="text-lg font-medium text-gray-100 mb-4">Theme Color</h2>
            <div className="flex flex-wrap gap-4 items-center">
              {PRESET_COLORS.map(c => (
                <button
                  ...
                  style={{
                    ...
                    border: formData.themeColor === c.hex ? '2px solid white' : '2px solid transparent',
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  onChange={(e) => handleColorChange(e.target.value)}
                  className="w-24 bg-[#2A2D35] border border-gray-700 rounded px-2 py-1.5 text-sm text-gray-100 focus:outline-none uppercase"
                />
              </div>
            </div>
          </div>
          ...
          {/* Documents Section */}
          <div className="bg-[#1A1D24] p-6 rounded-xl border border-gray-800">
            <h2 className="text-lg font-medium text-gray-100 mb-4">Documents</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-sm text-gray-400">PDF Footer Note</label>
                <input
                  type="text"
                  name="pdfHeaderNote"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#2A2D35] border border-gray-700 rounded-lg px-4 py-2 text-gray-100 focus:outline-none focus:border-brand-primary uppercase"
                />
                <p className="text-xs text-gray-500">Preview: {formData.invoicePrefix || 'INV'}-001</p>
              </div>
            </div>
          </div>
