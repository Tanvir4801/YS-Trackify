...
export function SelectTrigger({ className, children }) {
  ...
  return (
    <select
      ...
      className={clsx(
        'h-10 w-full rounded-md border border-border bg-bg-input px-3 py-2 text-[13px] text-text-primary shadow-sm outline-none focus:border-gold focus:ring-2 focus:ring-gold/20',
        className,
      )}
    >
